...
#ifndef __SIBACCESSNOTA_SERVICE_H___
#define __SIBACCESSNOTA_SERVICE_H___
...
void SibAccessNota_Query_req_process( struct context_pointer* context, uint8_t* nodeid, uint16_t nodeid_len, uint8_t* spaceid, uint16_t spaceid_len, uint32_t msgnum, query_format_t format, uint8_t* query, uint16_t query_len, confirm_t confirm );
void SibAccessNota_Subscribe_req_process( struct context_pointer* context, uint8_t* nodeid, uint16_t nodeid_len, uint8_t* spaceid, uint16_t spaceid_len, uint32_t msgnum, query_format_t format, uint8_t* query, uint16_t query_len, confirm_t results );
...
#endif /*  __SIBACCESSNOTA_SERVICE_H___ */
